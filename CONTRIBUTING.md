...
Do you have a question? Feel free to [open an issue](https://github.com/jlcanovas/vocareum-helper/issues/new?assignees=&labels=question&template=question.md).
...
Sometimes the issue you want to report is being already addressed, or is planned to be addressed soon. Before you create a new issue, please do a search in [open issues](https://github.com/jlcanovas/vocareum-helper/issues) to see if the issue or feature request has already been filed.
...
If you cannot find an existing issue that describes your bug or feature, [create a new issue](https://github.com/jlcanovas/vocareum-helper/issues/new?assignees=&labels=&template=proposal.md). The template will guide you on the issue reporting.
